...
function get_the_replaced_heading(?array $match): string
{
    ...
    return "<div class=\"toc-title-container toc-title-h$match[1]\"><span data-href=\"#$heading_id\" class=\"toc_ref toc_button\">#</span><h$match[1] id=\"$heading_id\"$match[2]>$match[3]</h$match[1]></div>";
}
